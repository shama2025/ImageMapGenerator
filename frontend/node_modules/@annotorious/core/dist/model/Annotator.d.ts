import { Annotation } from '@annotorious/core/src/model/Annotation';
import { User } from '@annotorious/core/src/model/User';
import { PresenceProvider } from '@annotorious/core/src/presence';
import { History, HoverState, SelectionState, Store, UndoStack, UserSelectActionExpression, ViewportState } from '@annotorious/core/src/state';
import { LifecycleEvents } from '@annotorious/core/src/lifecycle';
import { FormatAdapter } from '@annotorious/core/src/model/FormatAdapter';
import { DrawingStyleExpression } from '@annotorious/core/src/model/DrawingStyle';
import { Filter } from '@annotorious/core/src/model/Filter';
/**
